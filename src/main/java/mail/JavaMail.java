...
// ---------------------------------------------------------基本資料
	...
	private String userName = "willy01314@gmail.com"; // 寄件者信箱
	private String password = "kzzizcjpmeapndtt"; // 寄件者密碼
	private String customer = "yijie07040119@gmail.com"; // 收件者郵箱
	private String subject = "測試郵件"; // 標題
	private String txt = "image: <img src=\\\"sock.jpg\\\" />\""; // 內容
